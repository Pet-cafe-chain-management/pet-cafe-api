...
namespace PetCafe.Infrastructures.Migrations
{
    ...
    [Migration("20251116145609_Add_LeaveRequest_And_EmployeeOptionalWorkShift")]
    partial class Add_LeaveRequest_And_EmployeeOptionalWorkShift
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.DailyTask", b =>
                {
                    ...
                    b.HasIndex("VaccinationScheduleId")
                        .HasDatabaseName("i_x_daily_tasks_vaccination_schedule_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.DailyTask", b =>
                {
                    ...
                    b.HasOne("PetCafe.Domain.Entities.VaccinationSchedule", "VaccinationSchedule")
                        .WithMany()
                        .HasForeignKey("VaccinationScheduleId")
                        .HasConstraintName("f_k_daily_tasks_vaccination_schedules_vaccination_schedule_id");
