...
namespace PetCafe.Infrastructures.Migrations
{
    ...
    [Migration("20251018204714_Update_EmployeeSchedule_2025_10_19_03_45")]
    partial class Update_EmployeeSchedule_2025_10_19_03_45
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Area", b =>
                {
                    ...
                    b.HasIndex("WorkTypeId")
                        .HasDatabaseName("i_x_areas_work_type_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasIndex("WorkTypeId")
                        .HasDatabaseName("i_x_services_work_type_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.ServicePetGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PetGroupId")
                        .HasDatabaseName("i_x_service_pet_groups_pet_group_id");

                    b.HasIndex("ServiceId")
                        .HasDatabaseName("i_x_service_pet_groups_service_id");

                    b.ToTable("service_pet_groups");
                });
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasIndex("AreaId")
                        .HasDatabaseName("i_x_teams_area_id");
                    ...
                    b.HasIndex("WorkTypeId")
                        .HasDatabaseName("i_x_teams_work_type_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Area", b =>
                {
                    b.HasOne("PetCafe.Domain.Entities.WorkType", "WorkType")
                        ...
                        .IsRequired()
                        .HasConstraintName("f_k_areas_work_types_work_type_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Service", b =>
                {
                    b.HasOne("PetCafe.Domain.Entities.WorkType", "WorkType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_services_work_types_work_type_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.ServicePetGroup", b =>
                {
                    b.HasOne("PetCafe.Domain.Entities.PetGroup", "PetGroup")
                        .WithMany("ServicePetGroups")
                        .HasForeignKey("PetGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_service_pet_groups_pet_groups_pet_group_id");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Service", "Service")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_service_pet_groups_services_service_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Team", b =>
                {
                    b.HasOne("PetCafe.Domain.Entities.Area", "Area")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_teams_areas_area_id");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.WorkType", "WorkType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_teams_work_types_work_type_id");
