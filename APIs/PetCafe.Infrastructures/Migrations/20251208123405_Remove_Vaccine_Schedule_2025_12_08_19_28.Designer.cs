...
namespace PetCafe.Infrastructures.Migrations
{
    ...
    [Migration("20251208123405_Remove_Vaccine_Schedule_2025_12_08_19_28")]
    partial class Remove_Vaccine_Schedule_2025_12_08_19_28
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.EmployeeOptionalWorkShift", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "WorkShiftId")
                        .IsUnique()
                        .HasDatabaseName("i_x_employee_optional_work_shifts_employee_id_work_shift_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.LeaveRequest", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "LeaveDate")
                        .HasDatabaseName("i_x_leave_requests_employee_id_leave_date");

                    b.HasIndex("Status", "ReviewedBy")
                        .HasDatabaseName("i_x_leave_requests_status_reviewed_by");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.VaccinationRecord", b =>
                {
                    ...
                    b.HasIndex("PetId", "Name", "VaccinationDate")
                        .HasDatabaseName("i_x_vaccination_records_pet_id_name_vaccination_date");
