...
namespace PetCafe.Infrastructures.Migrations
{
    ...
    [Migration("20251025214459_Update_db_2025_10_26_04_44")]
    partial class Update_db_2025_10_26_04_44
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.EmployeeSchedule", b =>
                {
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("i_x_employee_schedules_employee_id");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Slot", b =>
                {
                    ...
                    b.Property<Guid?>("PetGroupId1")
                        .HasColumnType("uuid")
                        .HasColumnName("pet_group_id1");
                    ...
                    b.HasIndex("AreaId1")
                        .HasDatabaseName("i_x_slots_area_id1");

                    b.HasIndex("PetGroupId")
                        .HasDatabaseName("i_x_slots_pet_group_id");

                    b.HasIndex("PetGroupId1")
                        .HasDatabaseName("i_x_slots_pet_group_id1");

                    b.HasIndex("PetId")
                        .HasDatabaseName("i_x_slots_pet_id");

                    b.HasIndex("PetId1")
                        .HasDatabaseName("i_x_slots_pet_id1");

                    b.HasIndex("ServiceId")
                        .HasDatabaseName("i_x_slots_service_id");

                    b.HasIndex("ServiceId1")
                        .HasDatabaseName("i_x_slots_service_id1");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("i_x_slots_task_id");

                    b.HasIndex("TaskId1")
                        .HasDatabaseName("i_x_slots_task_id1");

                    b.HasIndex("TeamId")
                        .HasDatabaseName("i_x_slots_team_id");

                    b.HasIndex("TeamId1")
                        .HasDatabaseName("i_x_slots_team_id1");
            ...
            modelBuilder.Entity("PetCafe.Domain.Entities.Slot", b =>
                {
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Area", null)
                        ...
                        .HasConstraintName("f_k_slots_areas_area_id1");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.PetGroup", null)
                        .WithMany("Slots")
                        .HasForeignKey("PetGroupId1")
                        .HasConstraintName("f_k_slots_pet_groups_pet_group_id1");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Pet", null)
                        .WithMany("Slot")
                        .HasForeignKey("PetId1")
                        .HasConstraintName("f_k_slots_pets_pet_id1");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Service", null)
                        .WithMany("Slots")
                        .HasForeignKey("ServiceId1")
                        .HasConstraintName("f_k_slots_services_service_id1");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Task", null)
                        .WithMany("Slots")
                        .HasForeignKey("TaskId1")
                        .HasConstraintName("f_k_slots_tasks_task_id1");
                    ...
                    b.HasOne("PetCafe.Domain.Entities.Team", null)
                        .WithMany("Slots")
                        .HasForeignKey("TeamId1")
                        .HasConstraintName("f_k_slots_teams_team_id1");
